...
ABANDON_PET = "Êtes vous sur d'abandonner ton animal de façon permanent ?"; -- Confirmation dialog
ABANDON_QUEST = "Abandonner la quête"; -- Quit the currently selected quest
ABANDON_QUEST_CONFIRM = "Abandonner \"%s\" ?";
ABILITIES = "Abilités"; -- The player's abilities ''
ABILITYBOOK_BUTTON = "Abilités";
ABSORB = "Absorber";
ABSORB_CAPS = "ABSORBÉ"; -- Absorb an attack
ACCEPT = "Accepter"; -- Generic "accept"
ADDMEMBER = "Ajouer un Membre";
ADD_CHANNEL = "Entrer un nom de chat";
ADD_CHAT_CHANNEL = "Ajouter un chat";
ADD_FRIEND = "Ajouter un ami"; -- Add a friend to your friends list
ADD_FRIEND_LABEL = "Entrer le nom d'un ami a ajouter :"; -- Editbox label for adding a friend
ADD_GUILDMEMBER_LABEL = "Ajouter un membre de guilde :";
ADD_GUILDRANK_LABEL = "Ajouter un rang de guilde :";
ADD_IGNORE_LABEL = "Entrer un joueur a ignorer :"; -- Editbox label for ignoring a player
ADD_RAIDMEMBER_LABEL = "Ajouter un membre dans le raid:";
ADD_RAID_MEMBER = "Ajouter un membre";
AGILITY_COLON = "Agilité :"; -- Character's agility, with colon
AGILITY_TOOLTIP = "Améliore le taux de chance critique sur tout les personnages. Le\nmontant du bonus est plus part point sur les voleurs que\nles autres classes. L'agilité affecte l'esquive. Les voleurs ont plus\nd'esquive par point d'agilités que les autres classes. L'agilité\ns'ajoute directement dans l'armure."; -- Tooltip description for "Agility"
ALL = "Tout"; -- Generic All tag
ALLIED = "Alliée"; -- Label for whether you're allied with a faction or not
ALL_INVENTORY_SLOTS = "Tout les emplacements"; -- Text for inventory slot filter in the tradeskills frame
ALL_SUBCLASSES = "Tout les sous-classes"; -- Text for subclass filter in the tradeskills frame
ALREADY_LEARNED = "Déjà appris"; -- This service has already been learned
AMBIENCE_VOLUME = "Volume de l'ambiance"; -- Sound options tag
AMMOSLOT = "Munitions";
AMMO_DAMAGE_TEMPLATE = "Ajoute %g de dégats par seconde";
AMMO_SCHOOL_DAMAGE_TEMPLATE = "Ajoute %g %s de dégats par seconde";
AMOUNT_TO_SEND = "Montant a envoyer :";
ANIMATION = "Animation";
ANISOTROPIC = "Filtrage Anisotropic";
ARMOR = "Armure"; -- Generic "armor"
ARMOR_COLON = "Armure :"; -- Character's armor modifier, with colon
ARMOR_TEMPLATE = "%d Armure"; -- Item's armor display template
ARMOR_TOOLTIP = "Décroit le montant de degats que vous prenez des attaques physiques. Le montant de la reduction est influancé par le niveau de l'attaquant.\nRéduction de dégats contre un attaquant de niveau %d attacker: %.1f%%"; -- Tooltip description for "Armor"
ASSIGNED_COLON = "Déja assigné :"; -- Header for currently assigned quests, with colon
ASSIST_ATTACK = "Attaquer avec l'assistant"; -- Option to automatically attack after an "assist" command
ATTACHMENT_TEXT = "Déplacer un item ici pour l'inclure dans votre courrier";
ATTACK = "Attaquer"; -- Attack a target
ATTACK_COLON = "Attaquer :";
...
ATTACK_SPEED_TOOLTIP1 = "Dégats par secondes"; -- Tooltip for "Attack Speed"
ATTACK_TOOLTIP = "Indice d'attaque"; -- Tooltip description for "Attack"
AT_WAR = "En guerre"; -- At war tag for faction that the player is at war us
AUCTIONS = "Enchères";
AUCTION_BUYOUT_ERROR = "(Doit démarrer >= que le prix de départ)";
AUCTION_CREATOR = "Vendeur";
AUCTION_DURATION = "Temps des enchères";
AUCTION_DURATION_ERROR = "(L'enchère va etre mis dans 5 minutes)";
AUCTION_EXPIRED_MAIL_SUBJECT = "Enchère expiré : %s"; -- %s is the item name
AUCTION_ITEM = "Item aux enchères";
AUCTION_ITEM_TEXT = "Déplacer un item ici pour la mettre aux enchères";
AUCTION_OUTBID_MAIL_SUBJECT = "Surenchérir a %s"; -- %s is the item name
AUCTION_SOLD_MAIL_SUBJECT = "Enchère réussi : %s"; -- %s is the item name
AUCTION_TIME_LEFT1 = "Court";
AUCTION_TIME_LEFT1_DETAIL = "Moins de 30 minutes";
...
AUCTION_TIME_LEFT4_DETAIL = "Plus grand que 8 heures";
AUCTION_TITLE = "Enchère de %s";
AUCTION_WON_MAIL_SUBJECT = "Enchère gagné : %s"; -- %s is the item name
AURAADDEDOTHERHARMFUL = "%s est affecté par %s."; -- Combat log text for aura events
AURAADDEDOTHERHELPFUL = "%s gagne %s."; -- Combat log text for aura events
AURAADDEDSELFHARMFUL = "Vous êtes affecté par %s."; -- Combat log text for aura events
AURAADDEDSELFHELPFUL = "Vous gagner %s."; -- Combat log text for aura events
...
AURADISPELOTHER = "%s's %s a été retiré.";
AURADISPELSELF = "Vous avez retiré %s.";
AURAREMOVEDOTHER = "%s s'éloigne de %s."; -- Combat log text for aura events
AURAREMOVEDSELF = "%s s'éloigne de vous."; -- Combat log text for aura events
AUTOFOLLOWSTART = "Vous suivez %s.";
AUTOFOLLOWSTOP = "Vous arretez de suivre %s.";
AUTOFOLLOWSTOPCOMBAT = "Vous arretez de bouger pour attaquer %s";
AUTO_FOLLOW_SPEED = "Vitesse automatique de suivi";
AVAILABLE = "Disponible"; -- Generic available tag
AVAILABLE_QUESTS = "Quête disponibles"; -- Header for currently available quests
AVAILABLE_SERVICES = "Services disponibles";
AVERAGE_WAIT_TIME = "Temps d'attente moyenne :";
BACK = "Retour";
BACKGROUND = "Contexte"; -- Title in the chat preferences menu
BACKPACK_TOOLTIP = "Sac a dos"; -- Backpack tooltip
BACKSLOT = "Dos"; -- Back slot
BAGSLOT = "Sac"; -- Bag slot
BAGSLOTTEXT = "Emplacement de sac"; -- label for bags
BAGS_ONLY = "Uniquement les sacs peuvent être ici !"; -- The player can only put bags in this slot
BAG_CANT_STACK = "Cette item ne peut pas être groupé."; -- Can't have a stack of these
BAG_CANT_SWAP = "Cette item ne peut pas être échangé."; -- An error of sorts?
BAG_DROP_TOO_FAR_AWAY = "Ce point est trop loin pour lacher l'item."; -- You clicked too far away.
BAG_ERROR = "Ne peux pas bouger cette item pour une raison inconnu."; -- The client doesn't understand the specific result code, or the server had some sort of bug outside the bounds of things the player should know about.
BAG_FULL = "Le sac est plein !"; -- The player is trying to put an item into a full bag
BAG_ITEM_ALREADY_BOUND = "Cette item est relié."; -- The item is bound to its current owner and cannot be dropped or traded.
BAG_ITEM_CLASS_MISMATCH = "Vous ne pouvez pas placer cette item dans ce sac."; -- E.G. Only arrows go in quivers
BAG_ITEM_MAX_COUNT_EXCEEDED = "Vous en transportez trop."; -- Can only carry a limited number of the item total
BAG_ITEM_NOT_FOUND = "Cette item n'existe pas."; -- A request for an item that doesn't exist (could be caused by lag)
BAG_ITEM_SPLIT_FAILED = "Vous ne pouvez pas séparer cette item."; -- Some sort of internal error?
BAG_ITEM_SUBTYPE_MISMATCH = "Vous ne pouvez pas placer cette item dans ce sac."; -- E.G. Only CERTAIN arrows?!
BAG_ITEM_TOO_FEW_TO_SPLIT = "Vous ne pouvez pas sépare plus d'item que vous possedez."; -- Tried to split out too many of the item
BAG_NOT_A_CONTAINER = "N'est pas un emplacement."; -- Something that should have been a container, wasn't
...
BAG_NOT_EQUIPPABLE = "Cette item ne peux pas être équipé."; -- Item is not equippable, by anyone, ever
BAG_NOT_OWNER = "Vous ne possedez pas cette item."; -- Not owner of something specified
BAG_SLOT_EMPTY = "Cette emplacement est vide.";
BAG_SLOT_NOT_EMPTY = "Cette emplacement n'est pas vide.";
BANKSLOTPURCHASE = "Acheter"; -- Purchase button label
BANKSLOTPURCHASE_LABEL = "Voulez vous acheter un emplacement supplémentaire pour un sac supplémentaire ?";
...
BATTLEFIELD_JOIN = "Rejoindre la bataille";
BATTLEFIELD_LEVEL = "Plage de niveau:";
BATTLEFIELD_NAME = "Nom du Champs de bataille:";
BID = "Offre";
BIDS = "Offres";
BID_STATUS = "Status de l'offre";
BILLING_NAG_DIALOG = "Votre temps de jeu expire dans %d %s";
BILLING_NAG_WARNING = "Votre temps de jeu expire dans %d hour";
BILLING_NAG_WARNING_P1 = "Votre temps de jeu expire dans %d hours";
BINDING_HEADER_ACTIONBAR = "Fonctions de la barre d'action";
BINDING_HEADER_CAMERA = "Fonction de la caméra";
BINDING_HEADER_CHAT = "Fonction du chat";
BINDING_HEADER_INTERFACE = "Fonction du panel de l'interface";
BINDING_HEADER_MISC = "Fonctions divers";
BINDING_HEADER_MOVEMENT = "Touche de déplacement";
BINDING_HEADER_TARGETING = "Fonction de ciblage";
...
BINDING_NAME_ASSISTTARGET = "Assistant de ciblage";
BINDING_NAME_ATTACKTARGET = "Attaquer la cible";
...
BINDING_NAME_CAMERAZOOMOUT = "Dézommer";
BINDING_NAME_CHATBOTTOM = "Bas du chat";
BINDING_NAME_CHATPAGEDOWN = "Page bas du Chat";
BINDING_NAME_CHATPAGEUP = "Page haut du Chat";
BINDING_NAME_COMBATLOGBOTTOM = "Bas des informations de combat";
BINDING_NAME_COMBATLOGPAGEDOWN = "Page du bas des informations de combats";
BINDING_NAME_COMBATLOGPAGEUP = "Page du haut des informations de combats";
BINDING_NAME_FLIPCAMERAYAW = "Changer la caméra";
BINDING_NAME_FOLLOWTARGET = "Suivre la cible";
BINDING_NAME_JUMP = "Sauter";
BINDING_NAME_MASTERVOLUMEDOWN = "Baissez le son général";
BINDING_NAME_MASTERVOLUMEUP = "Augmenter le son général";
BINDING_NAME_MINIMAPZOOMIN = "Zoomer la Minimap";
BINDING_NAME_MINIMAPZOOMOUT = "Dézoomer la Minimap";
BINDING_NAME_MOVEBACKWARD = "Reculer";
BINDING_NAME_MOVEFORWARD = "Avancer";
BINDING_NAME_NAMEPLATES = "Afficher les plaques de nom";
BINDING_NAME_NEXTACTIONPAGE = "Bar d'action suivante";
BINDING_NAME_NEXTVIEW = "Affichage suivant";
BINDING_NAME_OPENALLBAGS = "Afficher tout les sacs";
BINDING_NAME_OPENCHAT = "Ouvrir le chat";
BINDING_NAME_OPENCHATSLASH = "Ouvrir le chat avec un backslash";
BINDING_NAME_PETATTACK = "Attaque de l'animal";
BINDING_NAME_PITCHDOWN = "Baissez le ton";
BINDING_NAME_PITCHUP = "Augmenter le ton";
BINDING_NAME_PREVIOUSACTIONPAGE = "Barre d'action précédente";
BINDING_NAME_PREVVIEW = "Vue précédente";
BINDING_NAME_REPLY = "Répondre au chat";
BINDING_NAME_RESETVIEW1 = "Réinitialiser la vue 1";
BINDING_NAME_RESETVIEW2 = "Réinitialiser la vue 2";
BINDING_NAME_RESETVIEW3 = "Réinitialiser la vue 3";
BINDING_NAME_RESETVIEW4 = "Réinitialiser la vue 4";
BINDING_NAME_RESETVIEW5 = "Réinitialiser la vue 5";
BINDING_NAME_SAVEVIEW1 = "Sauvegarder la vue 1";
BINDING_NAME_SAVEVIEW2 = "Sauvegarder la vue 2";
BINDING_NAME_SAVEVIEW3 = "Sauvegarder la vue 3";
BINDING_NAME_SAVEVIEW4 = "Sauvegarder la vue 4";
BINDING_NAME_SAVEVIEW5 = "Sauvegarder la vue 5";
BINDING_NAME_SCREENSHOT = "Capture d'écran";
BINDING_NAME_SELFACTIONBUTTON1 = "Self Bouton d'action 1";
BINDING_NAME_SELFACTIONBUTTON10 = "Self Bouton d'action 10";
BINDING_NAME_SELFACTIONBUTTON11 = "Self Bouton d'action 11";
BINDING_NAME_SELFACTIONBUTTON12 = "Self Bouton d'action 12";
BINDING_NAME_SELFACTIONBUTTON2 = "Self Bouton d'action 2";
BINDING_NAME_SELFACTIONBUTTON3 = "Self Bouton d'action 3";
BINDING_NAME_SELFACTIONBUTTON4 = "Self Bouton d'action 4";
BINDING_NAME_SELFACTIONBUTTON5 = "Self Bouton d'action 5";
BINDING_NAME_SELFACTIONBUTTON6 = "Self Bouton d'action 6";
BINDING_NAME_SELFACTIONBUTTON7 = "Self Bouton d'action 7";
BINDING_NAME_SELFACTIONBUTTON8 = "Self Bouton d'action 8";
BINDING_NAME_SELFACTIONBUTTON9 = "Self Bouton d'action 9";
BINDING_NAME_SETVIEW1 = "Afficher la vue 1";
BINDING_NAME_SETVIEW2 = "Afficher la vue 2";
BINDING_NAME_SETVIEW3 = "Afficher la vue 3";
BINDING_NAME_SETVIEW4 = "Afficher la vue 4";
BINDING_NAME_SETVIEW5 = "Afficher la vue 5";
BINDING_NAME_SHAPESHIFTBUTTON1 = "Bouton d'action spécial  1";
BINDING_NAME_SHAPESHIFTBUTTON10 = "Bouton d'action spécial  10";
BINDING_NAME_SHAPESHIFTBUTTON2 = "Bouton d'action spécial  2";
BINDING_NAME_SHAPESHIFTBUTTON3 = "Bouton d'action spécial  3";
BINDING_NAME_SHAPESHIFTBUTTON4 = "Bouton d'action spécial  4";
BINDING_NAME_SHAPESHIFTBUTTON5 = "Bouton d'action spécial  5";
BINDING_NAME_SHAPESHIFTBUTTON6 = "Bouton d'action spécial  6";
BINDING_NAME_SHAPESHIFTBUTTON7 = "Bouton d'action spécial  7";
BINDING_NAME_SHAPESHIFTBUTTON8 = "Bouton d'action spécial  8";
BINDING_NAME_SHAPESHIFTBUTTON9 = "Bouton d'action spécial  9";
BINDING_NAME_SITORSTAND = "Alterner entre debout/assis";
BINDING_NAME_STRAFELEFT = "Aller a gauche";
BINDING_NAME_STRAFERIGHT = "Aller a droite";
BINDING_NAME_TARGETLASTHOSTILE = "Cibler le dernier ennemi";
...
BINDING_NAME_TARGETPARTYMEMBER1 = "Cibler le membre du groupe 1";
BINDING_NAME_TARGETPARTYMEMBER2 = "Cibler le membre du groupe 2";
BINDING_NAME_TARGETPARTYMEMBER3 = "Cibler le membre du groupe 3";
BINDING_NAME_TARGETPARTYMEMBER4 = "Cibler le membre du groupe 4";
BINDING_NAME_TARGETPARTYPET1 = "Cibler l'animal du groupe 1";
BINDING_NAME_TARGETPARTYPET2 = "Cibler l'animal du groupe 2";
BINDING_NAME_TARGETPARTYPET3 = "Cibler l'animal du groupe 3";
BINDING_NAME_TARGETPARTYPET4 = "Cibler l'animal du groupe 4";
BINDING_NAME_TARGETPET = "Cibler l'animal";
BINDING_NAME_TARGETPREVIOUSENEMY = "Cibler l'ennemi précédent";
BINDING_NAME_TARGETPREVIOUSFRIEND = "Cibler l'ami précédent";
BINDING_NAME_TARGETSELF = "Cibler soi-même";
BINDING_NAME_TOGGLEABILITYBOOK = "Afficher les abilités";
BINDING_NAME_TOGGLEAUTORUN = "Activer/désactiver la course automatique";
BINDING_NAME_TOGGLEBACKPACK = "Afficher le sac a dos";
BINDING_NAME_TOGGLEBAG1 = "Afficher le sac 1";
BINDING_NAME_TOGGLEBAG2 = "Afficher le sac 2";
BINDING_NAME_TOGGLEBAG3 = "Afficher le sac 3";
BINDING_NAME_TOGGLEBAG4 = "Afficher le sac 4";
BINDING_NAME_TOGGLEBAG5 = "Afficher le sac 5";
BINDING_NAME_TOGGLECHARACTER0 = "Afficher le menu du personnage";
BINDING_NAME_TOGGLECHARACTER1 = "Afficher le menu des compétences";
BINDING_NAME_TOGGLECHARACTER2 = "Afficher le menu des réputations";
BINDING_NAME_TOGGLECHARACTER3 = "Afficher le menu de l'animal";
BINDING_NAME_TOGGLECOMBATLOG = "Afficher les informations du combat";
BINDING_NAME_TOGGLEFPS = "Afficher la fréquence d'affichage (FPS)";
BINDING_NAME_TOGGLEFRIENDSTAB = "Afficher le menu des amis";
BINDING_NAME_TOGGLEGAMEMENU = "Afficher le menu du jeu ";
BINDING_NAME_TOGGLEGUILDTAB = "Afficher le menu de guilde";
BINDING_NAME_TOGGLEIGNORETAB = "Afficher le menu ignorer";
BINDING_NAME_TOGGLEMINIMAP = "Activer/désactiver la mini-carte";
BINDING_NAME_TOGGLEMUSIC = "Activer/désactiver la musique";
BINDING_NAME_TOGGLEPETBOOK = "Afficher le livre de l'animal";
BINDING_NAME_TOGGLEQUESTLOG = "Afficher le livre de quête";
BINDING_NAME_TOGGLERAIDTAB = "Afficher le menu du raid";
BINDING_NAME_TOGGLERUN = "Activer/désactiver la marche/course";
BINDING_NAME_TOGGLESHEATH = "Ranger/dégainer l'arme";
BINDING_NAME_TOGGLESOCIAL = "Afficher le menu des amis";
BINDING_NAME_TOGGLESOUND = "Activer/désactiver le son"; -- Key binding tag
BINDING_NAME_TOGGLESPELLBOOK = "Afficher le livre des compétences";
BINDING_NAME_TOGGLETALENTS = "Afficher l'arbre des talents";
BINDING_NAME_TOGGLEUI = "Afficher l'interface utilisateur"; -- Keybinding name for TOGGLEUI
BINDING_NAME_TOGGLEWHOTAB = "Afficher le menu Qui?";
BINDING_NAME_TOGGLEWORLDMAP = "Afficher la carte du monde";
BINDING_NAME_TURNLEFT = "Tourner a gauche";
BINDING_NAME_TURNRIGHT = "Tourner a droite";
BIND_KEY_TO_COMMAND = "Appuyer sur une touche pour le relier a une commande -> %s";
BIND_ZONE_DISPLAY = "Vous êtes liée a %s."; -- The zone name where your character is bound
BLOCK = "Parer"; -- Block an attack
BLOCKED = "Paré"; -- Blocked an attack
BLOCK_CAPS = "PARÉ"; -- Block an attack
...
BREATH_LABEL = "Respiration"; -- Used as the label for the breath status bar
BROWSE = "Naviguer";
BROWSE_AUCTIONS = "Naviguer dans les enchères";
BROWSE_NO_RESULTS = "Pas d'items trouvé";
BROWSE_SEARCH_TEXT = "Choisissez le critère de recherche et appuyer sur \"Rechercher\"";
BUFFERING = "Buffering";
BUFFER_DOUBLE = "Double";
BUG_BUTTON = "Bugs & Suggestions";
BUG_CATEGORY15 = "Traduction de langue";
BUG_CATEGORY14 = "Joueur contre joueur";
BUG_CATEGORY13 = "Divers";
BUG_CATEGORY12 = "Échange de compétences";
BUG_CATEGORY11 = "Items";
BUG_CATEGORY9 = "Art";
BUG_CATEGORY8 = "Quêtes & Histoire";
BUG_CATEGORY4 = "Villes";
BUG_CATEGORY2 = "Espace exterieur";
BUG_CATEGORY5 = "Interface utilisateurs";
BUG_CATEGORY7 = "Monstres - Placement";
BUG_CATEGORY3 = "Donjons";
BUG_CATEGORY1 = "Classe du personnage";
BUG_CATEGORY10 = "Son";
BUG_CATEGORY6 = "Monstres - Balance/Abilités";
BUG_CATEGORY_CHOOSE = "--> Merci de choisir une catégorie";
BUG_CATEGORY_ERROR = "Vous devez absolument choisir une catégorie pour une suggestion/bug.";
BUG_SUBMITTED = "Tramsmission du bug réussi";
BUG_SUBMIT_FAILED = "La transmission du bug a échoué";
BUYBACK_THIS_ITEM = "Racheter l'item";
BUYOUT = "Rachat";
