...
ARENA = "Arena";
ARENA_CONQUEST_POINTS = "Conquest Points";
...
BARBERSHOP_ERROR1 = "You are not currently in a barbershop session.";
BARBERSHOP_ERROR2 = "You do not have enough money.";
BARBERSHOP_ERROR3 = "You are already in a barbershop session.";
BARBERSHOP_ERROR4 = "Selected style and color combination is not available to you.";
BARBERSHOP_ERROR5 = "A system error occurred. Please try again.";
BASIC_LABEL = "Basic";
...
BINDINGS_RESET_TEXT = "Bindings Reset Successfully";
...
BINDING_PLACEHOLDER_TEXT = "Click on either button next to a binding to start the binding process";
...
CONFIRM_BUY_STABLE_SLOT = "Do you want to purchase a stable slot for:";
CONFIRM_DEFAULTS_RESET = "This will reset the '%s' options to their default values for all characters across your account. Do you want to continue?";
...
DONO_SHOP_TOOLTIP3 = "Hold alt and right-click to hide this button.";
...
EBC_STOPPED = "You stop listening to %s for now.";
EBC_TITLE = "Everlook Broadcasting Co.";
EBC_TUNEDINTO = "You are now tuned into %s!";
EBC_TUNEIN = "Tune In";
...
GAMETIME_LOCAL = "Local time:";
GAMETIME_SERVER = "Server time:";
GAMETIME_TITLE = "Clock";
GAMETIME_ZONE = "Zone time:";
...
GROUP = "Group";
GROUPS = "Groups";
GROUP_BORDER_TEXT = "Show Group Border";
GROUP_CLASS_COLORED_NAMES_TEXT = "Class Colored Names";
GROUP_DEBUFF_INDICATOR_STYLE_TEXT = "Debuff Indicator Style";
GROUP_ENABLED_TEXT = "Enable Compact Group Frame";
GROUP_HEADERS_TEXT = "Show Group Headers";
GROUP_INVITE = "Group Invite";
GROUP_REPLACE_PARTY_TEXT = "Replace Party UI";
GROUP_UNIT_GROW_DIRECTION_TEXT = "Unit Grow Direction";
GROUP_UNIT_HEALTH_CLASS = "Class";
GROUP_UNIT_HEALTH_COLOR_TEXT = "Unit Healthbar Color";
GROUP_UNIT_HEALTH_MISSING_HEALTH = "Missing Health";
GROUP_UNIT_HEALTH_STATIC = "Static";
GROUP_UNIT_HEIGHT_TEXT = "Unit Frame Height";
GROUP_UNIT_WIDTH_TEXT = "Unit Frame Width";
GUILD = "Guild";
...
GUILD_BANK_DEPOSITED = "|cffafafaf(%s)|r |cffffd200%s|r deposited %s";
GUILD_BANK_DESTROYED = "|cffafafaf(%s)|r |cffffd200%s|r destroyed %s";
...
GUILD_BANK_LOG = "Log";
GUILD_BANK_LOG_UNLOCK_BANK = "|cffafafaf(%s)|r |cffffd200%s|r unlocked Guild Bank for %s";
GUILD_BANK_LOG_UNLOCK_TAB1 = "|cffafafaf(%s)|r |cffffd200%s|r unlocked a Guild Tab with Guild Money for %s";
GUILD_BANK_LOG_UNLOCK_TAB2 = "|cffafafaf(%s)|r |cffffd200%s|r unlocked a Guild Tab with Personal Money for %s";
...
GUILD_BANK_WITHDREW = "|cffafafaf(%s)|r |cffffd200%s|r |cffff2020withdrew|r %s";
...
KEY_TAB = "Tab";
KEY_TILDE = "~";
KEY_UNBOUND = "Key Unbound Successfully";
...
LEVELING_CHALLENGE_HEROIC = "Trial of Heroism";
...
LFT_CHAT_SELECTED_ROLES_TEXT = "%s has selected these roles: %s";
LFT_DELETE_GROUP = "Unlist Group";
LFT_DELETE_GROUP_CONFIRM_TEXT = "Do you really want to unlist group \"%s\"?";
...
LFT_DUNGEON_FMH = "Frostmane Hollow";
LFT_DUNGEON_GILNEAS = "Gilneas City";
LFT_DUNGEON_GNOMER = "Gnomeregan";
LFT_DUNGEON_HFQ = "Hateforge Quarry";
...
LFT_DUNGEON_WINDHORN = "Windhorn Canyon";
LFT_DUNGEON_ZF = "Zul'Farrak";
LFT_EDIT_GROUP = "Edit Group";
LFT_GENERAL_BROWSE_TAB_TEXT = "Group Browser";
LFT_GENERAL_IN_RAID_TEXT = "You can't use dungeon finder while in a raid.";
...
LFT_GROUPS_TYPE2 = "Quests & Zones";
LFT_GROUPS_TYPE3 = "PvP";
LFT_GROUPS_TYPE4 = "Custom";
...
LFT_MINIMAP_TOOLTIP_LISTED = "Your group \"%s\" is listed.";
LFT_MINIMAP_TOOLTIP_NO_QUEUE = "You are not queued for any dungeons.";
LFT_MINIMAP_TOOLTIP_QUEUED = "You are queued for: ";
LFT_NEW_GROUP = "New Group";
LFT_PRESETS = "Presets";
LFT_PRESET_DELETE_TEXT = "Do you really want to delete preset \"%s\"?";
LFT_PRESET_ERROR_EXISTS = "Preset with this name already exists.";
LFT_PRESET_ERROR_NOT_VALID_NAME = "Preset name is not valid.";
LFT_PRESET_ERROR_NOT_VALID_TITLE = "Can not create preset. Title is not valid.";
LFT_PRESET_NEW_TEXT = "Enter Preset Name:";
LFT_PRESET_TOOLTIP_DELETE = "Delete Preset";
LFT_PRESET_TOOLTIP_SAVE = "Save Preset";
LFT_PRESET_TOOLTIP_SELECT = "Select Preset";
LFT_QUEUE = "Dungeon Finder";
LFT_ROLES = "Roles needed in total:";
LFT_ROLE_1 = "Tank";
LFT_ROLE_2 = "Healer";
LFT_ROLE_3 = "Damage";
LFT_ROLE_CHECK = "Role Check";
LFT_ROLE_CHECK_CONFIRM_TEXT = "Confirm";
LFT_ROLE_CHECK_DECLINE_TEXT = "Decline";
LFT_ROLE_CHECK_INSTANCES_TEXT = "Queued for: ";
LFT_ROLE_CHECK_MESSAGE = "%s has initiated a role check for listed group.";
LFT_ROLE_CHECK_MESSAGE_SELF = "You have initiated a role check for listed group.";
...
MERCHANT_PAGE_NUMBER = "Page %d of %d";
MERCHANT_STOCK = "(%d)";
...
MINIMAP_BATTLEGROUND_THORNGORGE = "Thorn Gorge";
MINIMAP_BATTLEGROUND_THORNGORGE_TOOLTIP = "Queue for Thorn Gorge";
...
NO_RESULTS_NO_PERIOD = "No results";
...
OPTIONS_UNSAVED_CHANGES_TEXT = "You have unsaved changes that need to be applied before you can continue. Do you want to apply the changes?";
OPTION_LOGOUT_REQUIREMENT = "Requires logout to take effect";
OPTION_RELOAD_REQUIREMENT = "Requires interface reload to take effect";
...
OPTION_TOOLTIP_GAMMA = "Controls the brightness of the game. Has no effect if the game is running in windowed mode.";
OPTION_TOOLTIP_GROUP_BORDER = "Show a border around the group frame.";
OPTION_TOOLTIP_GROUP_CLASS_COLORED_NAMES = "Enable to color group members' names based on their class.";
OPTION_TOOLTIP_GROUP_DEBUFF_INDICATOR_STYLE = "Customize the debuff indicator style.";
OPTION_TOOLTIP_GROUP_ENABLED = "Enable to use a compact group frame when in a raid group.";
OPTION_TOOLTIP_GROUP_HEADERS = "Show group headers above each raid group or party group.";
OPTION_TOOLTIP_GROUP_REPLACE_PARTY = "Enable to replace the standard party frame with the group frame instead.";
OPTION_TOOLTIP_GROUP_UNIT_GROW_DIRECTION = "Set the grow direction of the cluster unitframes.\n\nChanging this option will reset the position of all clusters!";
OPTION_TOOLTIP_GROUP_UNIT_HEALTH_COLORS = "Set how to color group members healthbars.";
...
OPTION_TOOLTIP_MULTISAMPLE = "Increase multisampling to smooth out model edges.";
...
OPTION_TOOLTIP_REFRESH = "Changes the monitor refresh rates when fullscreen mode is enabled. Higher rates flicker less.";
OPTION_TOOLTIP_REMOVE_CHAT_DELAY = "Check to show chat windows immediately upon mouseover.";
OPTION_TOOLTIP_RESOLUTION = "Changes the screen resolution of the game. Decrease to improve performance.";
...
OPTION_TOOLTIP_SHOW_GUILD_NAMES_ON_TOOLTIPS = "Always display player guild names in the tooltip.";
...
OPTION_TOOLTIP_TARGET_OF_TARGET_STATE = "Control when to show the Target of Target frame.";
...
OPTION_TOOLTIP_TERRAIN_MIP = "Sets the terrain texture detail.";
...
OPTION_TOOLTIP_TRILINEAR_FILTERING = "Enables high quality filtering of texture maps. Turn this feature off to increase performance.";
...
QUEST_MONEY_ALERT = "To complete this quest, you need to pay the amount specified below. Do you want to continue?";
...
SHOW_GUILD_NAMES_ON_TOOLTIPS = "Show Guild Names on Tooltips";
SHOW_HELM = "Show Helm";
...
SHOW_PLAYER_CHALLENGES_TEXT = "Show Player Challenges";
...
TAMEABLE = "Tameable";
TARGET = "Target";
TARGET_OF_TARGET_STATE_TEXT = "Target of Target Visibility";
...
TRANSMOG_APPEARANCE_COLLECTED = "%s has been added to your appearance collection.";
...
TW_TITLES_EARNED = "You have earned |cffffffff\"%s\"|r title.";
...
WARNING_NEED_RELOAD_TO_APPLY = "Changing this option requires you to reload the user interface. Do you want to reload now?";
WARNING_VERTEX_SHADERS = "Disabling this option may lead to rendering issues and unexpected game crashes. We recommend leaving this option enabled.";
WARNING_WINDOWED_MODE = "Disabling this option may cause black screen issue. We recommend leaving this option enabled.";
...
WORLDSTATE_REINFORCEMENTS = "Reinforcements";
