...
CHALLENGE_HEROIC = "Trial of Heroism";
CHALLENGE_HEROIC_TEXT = "Achieve level 58 by earning experience strictly from orange and red-tier monsters and quests.";
...
CHAR_RENAME_DESCRIPTION = "Your character has been marked for a rename";
...
REALM_LIST_REALM_NOT_FOUND = "The game server you have chosen is currently down. Use the Change Realm button to choose another Realm.";
